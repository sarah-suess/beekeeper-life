...
#define BACKGROUND  COLOR(21,25,20)
#define STEM    COLOR(5,8,1)
#define PALEYELLOW COLOR(30,30,21)
#define PALEPURPLE COLOR(18,19,27)
#define LIGHTPINK COLOR(31,13,21)
#define LIGHTBLUE COLOR(17,27,31)
#define LIGHTBROWN COLOR(19,11,7)
#define DARKBROWN COLOR(11,6,4)
