...
void goToStart() {
    ...
    drawBee(30,55,((30&31) | (30&31) << 5 | (21&31) << 10));

    char letters[11] = {'P', 'R', 'E', 'S', 'S', ' ', 'S', 'T','A','R','T'};
    unsigned short colors[11] = {((18&31) | (19&31) << 5 | (27&31) << 10), ((17&31) | (27&31) << 5 | (31&31) << 10), ((18&31) | (19&31) << 5 | (27&31) << 10), ((17&31) | (27&31) << 5 | (31&31) << 10), ((18&31) | (19&31) << 5 | (27&31) << 10), ((31&31) | (0&31) << 5 | (0&31) << 10), ((17&31) | (27&31) << 5 | (31&31) << 10), ((18&31) | (19&31) << 5 | (27&31) << 10), ((17&31) | (27&31) << 5 | (31&31) << 10), ((18&31) | (19&31) << 5 | (27&31) << 10), ((17&31) | (27&31) << 5 | (31&31) << 10)};
    int col = 55;
    int spacing = 12;
    for(int i = 0; i < 11; i++){
...
void goToGame() {
    fillScreen(((21&31) | (25&31) << 5 | (20&31) << 10));
    state = GAME;
}
...
void game() {
    ...
    drawString(190,1,"bee: ", ((0&31) | (0&31) << 5 | (0&31) << 10));
    drawString(190,8,"you: ", ((0&31) | (0&31) << 5 | (0&31) << 10));
    drawRect(220,1,12,8,((21&31) | (25&31) << 5 | (20&31) << 10));
    drawRect(220,8,12,8,((21&31) | (25&31) << 5 | (20&31) << 10));
    drawString(220,1,beeBuffer,((0&31) | (0&31) << 5 | (0&31) << 10));
    drawString(220,9,playerBuffer,((0&31) | (0&31) << 5 | (0&31) << 10));
...
void goToPause() {
    fillScreen(((31&31) | (31&31) << 5 | (31&31) << 10));
    drawBee(60,55,((31&31) | (31&31) << 5 | (0&31) << 10));
    drawBasket(170, 82, ((19&31) | (11&31) << 5 | (7&31) << 10));
    drawBerry(120,90);
    drawString(84, 60, "game paused!", ((0&31) | (0&31) << 5 | (0&31) << 10));
    waitForVBlank();
    state = PAUSE;
}
...
void goToWin() {
    fillScreen(((31&31) | (31&31) << 5 | (31&31) << 10));
    drawString(80, 60, "you won!!!", ((31&31) | (13&31) << 5 | (21&31) << 10));
    drawString(40, 70, "press start to play again", ((0&31) | (0&31) << 5 | (0&31) << 10));
    waitForVBlank();
    state = WIN;
}
...
void goToLose() {
    fillScreen(((31&31) | (31&31) << 5 | (31&31) << 10));
    drawString(80, 50, "you lost :(", ((17&31) | (27&31) << 5 | (31&31) << 10));
    drawString(30, 60, "how did you let a bee beat you??", ((0&31) | (0&31) << 5 | (0&31) << 10));
    waitForVBlank();
    state = LOSE;
}
